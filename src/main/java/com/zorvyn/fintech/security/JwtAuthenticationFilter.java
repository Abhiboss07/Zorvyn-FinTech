...
import com.zorvyn.fintech.service.SessionService;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && jwtTokenProvider.validateAccessToken(jwt)) {
                ...
                // Validate that a Redis session exists for this user
                if (sessionService.isSessionValid(userId.toString())) {
                    ...
                    sessionService.extendSession(userId.toString());
                }
            }
        } catch (Exception ex) {
